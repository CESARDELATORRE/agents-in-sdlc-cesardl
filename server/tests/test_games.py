...
class TestGamesRoutes(unittest.TestCase):
    ...
    def test_create_game_success(self) -> None:
        ...
        new_game_data = {
            ...
            "description": "Navigate through pull requests and code reviews to ship your features",
            "category_id": 1,
            "publisher_id": 1,
            "star_rating": 4.3
        }
    ...
    def test_update_game_success(self) -> None:
        ...
        games_data = self._get_response_data(games_response)
    ...
    def test_delete_game_success(self) -> None:
        ...
        games_response_after = self.client.get(self.GAMES_API_PATH)
        games_data_after = self._get_response_data(games_response_after)
        self.assertEqual(len(games_data_after), initial_count - 1)
        
        # Verify the specific game is gone
        game_response = self.client.get(f'{self.GAMES_API_PATH}/{game_id}')
        self.assertEqual(game_response.status_code, 404)
